...
- practice problem on the project
...
def station_stats(df):
    ...
    # here print the start and end station. 
...
def table_stats(df, city):
    ...
    # This code code was inspiered by https://stackoverflow.com/questions/28199524/best-way-to-count-the-number-of-rows-with-       missing-values-in-a-pandas-dataframe
